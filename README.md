...
*ADCP_pycurrents_L1_NEW1.py* uses the rawfile() kwarg "trim"=True to remove "garbage" from the ends of files as well as exception handling for the instrument orientation decoder (SysCfg().up) and for cutting trailing ensembles from after deployment.
