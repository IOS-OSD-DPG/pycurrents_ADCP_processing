...
out = xr.Dataset(coords={'time': time_us, 'distance': data.dep, 'station': station, 'nchar': nchar},
                 data_vars={'time_var': (['time'], time_us),
                            ...
                            'LCEWAP01': (['time', 'distance'], vel.vel1.data),
                            ...
                            'filename': (['nchar'], np.array([outname[-4]])),
                            'instrument_serial_number': (['nchar'], np.array([meta_dict['serialNumber']])),
                            'instrument_model': (['nchar'], np.array([meta_dict['instrumentModel']]))})
